...
url = 'https://api.themoviedb.org/3/movie/popular?api_key=0addcecf0cd16afdf3f9a70dbb13a388'
...
def search(movieTitle):
    ...
    if not movie: #movie is an empty list
        return "The Movie Title of {movieTitle}, does not exist, sorry!"
    else: #valid movie
...
def search_movie(movie):
    ...
    params = {
        ...
        "api_key": "0addcecf0cd16afdf3f9a70dbb13a388",  #api key
